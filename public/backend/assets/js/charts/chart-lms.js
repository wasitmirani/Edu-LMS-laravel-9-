...
!(function (NioApp, $) {
        ...
        datasets: [
            {
                ...
                data: [
                    11e3, 8e3, 12500, 5500, 9500, 14299, 11e3, 8e3, 12500, 5500,
                    9500, 14299,
                ],
            },
        ],
        ...
        datasets: [
            ...
            },
            {
                ...
                color: [
                    ...
                    NioApp.hexRGB("#6baafe", 0.4),
                    NioApp.hexRGB("#8feac5", 0.4),
                    NioApp.hexRGB("#6b79c8", 0.4),
                    NioApp.hexRGB("#79f1dc", 0.4),
                    NioApp.hexRGB("#FF65B6", 0.4),
                    NioApp.hexRGB("#6A29FF", 0.4),
                ],
                        ...
                        callbacks: {
                            ...
                            label: function (a, t) {
                                return (
                                    t.datasets[a.datasetIndex].data[a.index] +
                                    " " +
                                    t.datasets[a.datasetIndex].label
                                );
                            },
                        },
                        backgroundColor: "#eff6ff",
        ...
        datasets: [
            {
                ...
                data: [
                    ...
                    950, 1100, 800, 1250, 850, 950, 450, 900, 1e3, 1200, 1250,
            ...
            datasets: [
                {
                    label: "Courses",
                    color: "#6A29FF",
                    background: NioApp.hexRGB("#6A29FF", 0.25),
                    data: [
                        85, 125, 105, 115, 130, 106, 141, 110, 95, 120, 111,
                        105, 113, 107, 122, 100, 95, 110, 120, 107, 100, 105,
                        123, 115, 110, 117, 125, 75, 95, 101,
                    ],
                },
            ],
        },
            ...
            datasets: [
                {
                    label: "Students",
                    color: "#4258FF",
                    background: NioApp.hexRGB("#4258FF", 0.25),
                    data: [
                        92, 105, 125, 85, 110, 106, 131, 105, 110, 115, 135,
                        105, 120, 85, 122, 100, 125, 110, 120, 125, 85, 105,
                        123, 115, 90, 117, 125, 100, 95, 65,
                    ],
                },
            ],
        };
    ...
    var TrafficChannelDoughnutData = {
        ...
        datasets: [
            {
                borderColor: "#fff",
                background: ["#0071dc", "#b8acff", "#ffa9ce", "#f9db7b"],
        ...
        datasets: [
            {
                label: "Sales",
                color: "#0071dc",
                background: NioApp.hexRGB("#0071dc", 0.25),
                data: [
    ...
    datasets: [
        {
            ...
            data: [
                ...
                4790, 4950, 5100, 5800, 5950, 5850, 5950, 4450, 4900, 8e3, 7200,
                7250, 7900, 8950, 6300, 7200, 7250, 7650, 6950, 4750,
            ],
        },
    ],
};
