    ...
    return (function e(d) {
        ...
        function r(e, t, r) {
            if ("undefined" != typeof document) {
                "number" ==
                    typeof (r = s({ path: "/" }, i.defaults, r)).expires &&
                    (r.expires = new Date(+new Date() + 864e5 * r.expires)),
        ...
        (i.Demo = {
            ...
            style: function (e, t) {
                ...
                return "all" === e
                    ? r[t] || ""
                    : "any" === e
                    ? r.mode + " " + r.style + " " + r.aside + " " + r.header
                    : "body" === e
                    ? r.mode + " " + r.style
                ...
                try {
                    for (t.s(); !(e = t.n()).done; ) {
                        ...
                        ("aside" !== a && "header" !== a && "style" !== a) ||
                            ((r = i.Demo.defs(a)),
                            s(
                                (o = "aside" === a ? c : "header" === a ? f : d)
                            ).removeClass(i.Demo.style("all", a)),
                            "ui-default" !== r &&
                                "is-default" !== r &&
                                s(o).addClass(r)),
                            "mode" === a &&
                                i.Demo.update(a, i.Demo.current("mode")),
                            "skin" === a &&
                                i.Demo.update(a, i.Demo.current("skin"));
                    }
                } catch (e) {
                    t.e(e);
                } finally {
            ...
            locked: function (e) {
                !0 === e
                    ? (s(y + "[data-key=aside]")
                      ...
                      s(y + "[data-key=skin][data-update=default]").addClass(
                          "active"
                      ))
                    : s(y + "[data-key=aside]")
                          .add(y + "[data-key=header]")
            ...
            update: function (e, t, r) {
                ...
                i.Demo.apps();
                ("aside" !== e && "header" !== e) ||
                    (s((o = "header" == e ? f : c)).removeClass(n),
                    s(o).addClass(a)),
                    "mode" === e &&
                        (d.removeClass(n).removeAttr("theme"),
                        a === p
                            ? (d.addClass(a).attr("theme", "dark"),
                              i.Demo.locked(!0))
                            : (d.addClass(a).removeAttr("theme"),
                              i.Demo.locked(!1))),
                    ...
                    "skin" === e &&
                        ...
                        "theme" === o
                            ...
                            ? s(u).attr("href", n)
                            : l.append(
                                  '<link id="skin-theme" rel="stylesheet" href="' +
                                      n +
                                      '">'
                              )),
                    !0 === r && i.Demo.save(e, t);
                    ...
                    for (r.s(); !(e = r.n()).done; ) {
                        ...
                        s("[data-key='" + o + "']").each(function () {
                            ...
                            ("aside" !== o &&
                                "header" !== o &&
                                "style" !== o) ||
                                (e === v[t][o] && s(this).addClass("active")),
                                ("mode" !== o && "skin" !== o) ||
                                    (e !== a && "default" !== e) ||
            ...
            (i.Promo = function () {
                ...
                0 < e.length &&
                    ...
                    s(window).on("load", function () {
                        (null == Cookies.get("intm-offer") ? r : t).addClass(
                            "active"
                        );
                    });
            }),
