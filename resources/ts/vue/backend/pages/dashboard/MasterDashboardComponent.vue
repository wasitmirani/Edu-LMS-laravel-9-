                                                   ...
                                                   <div class="nk-sale-data-group flex-md-nowrap g-4">
                                                      <div class="nk-sale-data"><span class="amount">5490
                                                         <span class="change down text-danger"><em
                                                            ...
                                                            class="sub-title">This Month</span>
                                                      </div>
                                          ...
                                          <div class="card">
                                             <div class="nk-ecwg nk-ecwg3">
                                                ...
                                                <div class="nk-ecwg3-ck">
                                                   <canvas class="courseSells"
                                                      id="totalSells"></canvas>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="review-item d-flex justify-content-between">
                                                <div class="user-card">
                                                   ...
                                                   <div class="user-info"><span class="lead-text">Ashley
                                                      Lawson</span><span
                                                         class="sub-text">ashley@softnio.com</span>
                                                   </div>
                                                </div>
                                                <div class="review-status">
                                                   <ul class="review-stars d-flex">
                                                ...
                                                <div class="user-card">
                                                   ...
                                                   <div class="user-info"><span class="lead-text">Jane
                                                      Montgomery</span><span
                                                         class="sub-text">jane84@example.com</span>
                                                   </div>
                                                </div>
                                                <div class="review-status">
                                                   <ul class="review-stars d-flex">
                                    ...
                                    <div class="card h-100">
                                       ...
                                       <ul class="nk-support">
                                          <li class="nk-support-item">
                                             <div class="user-avatar"><img src="backend/images/avatar/a-sm.jpg"
                                                alt=""></div>
                                          ...
                                          <li class="nk-support-item">
                                             <div class="user-avatar"><img src="backend/images/avatar/b-sm.jpg"
                                                alt=""></div>
                                             <div class="nk-support-content">
                                                <div class="title">
