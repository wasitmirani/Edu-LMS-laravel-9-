...
<body class="nk-body bg-white npc-default pg-auth">
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            ...
                            <img class="logo-light logo-img logo-img-lg" src="{{asset('backend/images/logo.png')}}"
                                    srcset="/backend/images/logo2x.png 2x" alt="logo"><img
                                    class="logo-dark logo-img logo-img-lg" src="{{asset('/backend/images/logo-dark.png')}}"
                                    srcset="{{asset('/backend/images/logo-dark2x.png')}} 2x" alt="logo-dark"></a></div>
                        @yield('content')
                    </div>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end">
                                                <ul class="language-list">
                                                    <li><a href="#" class="language-item"><img
                                                                src="/backend/images/flags/english.png" alt=""
                                                                class="language-flag"><span
                                                                class="language-name">English</span></a></li>
                                                    <li><a href="#" class="language-item"><img
                                                                src="/backend/images/flags/spanish.png" alt=""
                                                                class="language-flag"><span
                                                                class="language-name">Español</span></a></li>
                                                    <li><a href="#" class="language-item"><img
                                                                src="/backend/images/flags/french.png" alt=""
                                                                class="language-flag"><span
                                                                class="language-name">Français</span></a></li>
                                                    <li><a href="#" class="language-item"><img
                                                                src="/backend/images/flags/turkey.png" alt=""
                                                                class="language-flag"><span
    ...
    <script src="/backend/assets/js/bundle.js?ver=3.0.2"></script>
    <script src="/backend/assets/js/scripts.js?ver=3.0.2"></script>
    <script src="/backend/assets/js/demo-settings.js?ver=3.0.2"></script>
